...
# General Environment Settings
MAX_AIRCRAFT = 20  # Maximum number of aircraft considered in the environment
...
TIME_MINUTE_PENALTY = 10                 # penalty for every minute passed, each timestep cumulatively
