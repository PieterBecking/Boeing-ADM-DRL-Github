...
def main():
    ...
    if 'TRAINING_FOLDERS_PATH' not in globals():
        TRAINING_FOLDERS_PATH = "../data/Training/6ac-10-deterministic-na/"
    ...
    if 'TEST_FOLDERS_PATH' not in globals():
        TESTING_FOLDERS_PATH = "../data/Testing/3ac-1-mixed/"
    if 'CROSS_VAL_INTERVAL' not in globals():
        CROSS_VAL_INTERVAL = 10000000000000
    if 'printing_intermediate_results' not in globals():
    ...
    def train_dqn_agent(env_type):
        ...
        while total_timesteps < MAX_TOTAL_TIMESTEPS:    
            ...
            if printing_intermediate_results:
    ...
    plt.plot(myopic_steps_sm, myopic_mean_sm, label="Myopic DQN", color='blue')
    plt.fill_between(myopic_steps_sm, 
                    myopic_mean_sm - myopic_std_sm, 
                    myopic_mean_sm + myopic_std_sm, 
                    alpha=0.2, color='blue')

    plt.plot(proactive_steps_sm, proactive_mean_sm, label="Proactive DQN", color='orange')
